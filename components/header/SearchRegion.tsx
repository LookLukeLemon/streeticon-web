...
const SearchRegion = () => {
  return (
    <div className="flex-1 px-8 flex items-center justify-between text-zinc-400">
      ...
      <div className="relative hidden lg:flex text-zinc-100 items-center rounded-full text-sm px-4 py-2.5 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 font-semibold">
